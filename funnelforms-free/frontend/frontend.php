    ...
    function fnsf__af2_generate_frontend($atts) {
        ...
        /** Check if license is active * */
            ...
            if ($base_json != null) {
                ...
                if(isset($base_json->activateScrollToAnchorDesktop) && ($base_json->activateScrollToAnchorDesktop === 'true' || $base_json->activateScrollToAnchorDesktop === true)) {
                    $aScrollToAnchorDesktop = true;
                }
                ...
                $content .= '<div id="af2_form_' . $this->frontend_id . '" class="af2_form_wrapper af2_form-type-'.$type.'"
                                ...
                                data-did="' . $dataid . '" data-errormail="' . $errormail . '" data-activatescrolltoanchor="' . $aScrollToAnchor . '" data-activatescrolltoanchordesktop="'. $aScrollToAnchorDesktop . '" data-showsuccessscreen="'.$aShowSuccessScreen.'"
                                >';
